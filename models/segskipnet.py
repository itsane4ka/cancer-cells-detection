...
class DeConvSkipNet(nn.Module):
    def __init__(self):
        super(DeConvSkipNet, self).__init__()
    ...
    def forward(self, x):
        x1, index_1 = self.pool_1(self.conv_1_2(self.conv_1_1(x)))
        x2, index_2 = self.pool_2(self.conv_2_2(self.conv_2_1(x1)))
        x3, index_3 = self.pool_3(self.conv_3_2(self.conv_3_1(x2)))
        x4, index_4 = self.pool_4(self.conv_4_2(self.conv_4_1(x3)))

        x = self.conv_5_2(self.conv_5_1(x4))
        x = self.deconv_5_3(x)
        x = self.unpool_4(self.relu_4(x+x4), index_4)

        x = self.unpool_3(self.relu_3(self.deconv_6_2(self.deconv_6_1(x))+x3), index_3)
        x = self.unpool_2(self.relu_2(self.deconv_7_2(self.deconv_7_1(x))+x2), index_2)
        x = self.unpool_1(self.relu_1(self.deconv_8_2(self.deconv_8_1(x))+x1), index_1)
